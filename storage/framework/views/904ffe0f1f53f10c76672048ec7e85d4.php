...
<head>
    <meta charset="utf-8">
    <title><?php echo e(config('app.name', 'Yasser Elgammal')); ?></title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
        <a href="index.html" class="navbar-brand ml-lg-3">
            <h1 class="m-0 display-5"><span class="text-primary">Dentist's</span>DEN</h1>
        </a>
...
<?php /**PATH C:\xampp\htdocs\dentistden\dentistden\resources\views/layouts/app.blade.php ENDPATH**/ ?>